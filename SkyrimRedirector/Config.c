...
#define SR_DEFAULT_REDIRECTION_INI L"\\My Games\\Skyblivion\\Skyblivion.ini"

// The default file path to where SkyrimPrefs.ini will be redirected, relative to the Documents folder.
#define SR_DEFAULT_REDIRECTION_PREFS_INI L"\\My Games\\Skyblivion\\SkyblivionPrefs.ini"

// The default file path to where SkyrimCustom.ini will be redirected, relative to the Documents folder.
#define SR_DEFAULT_REDIRECTION_CUSTOM_INI L"\\My Games\\Skyblivion\\SkyblivionCustom.ini"

// The default file path to where plugins.txt will be redirected, relative to the Local AppData folder.
#define SR_DEFAULT_REDIRECTION_PLUGINS L"\\Skyblivion Team\\Skyblivion\\plugins.txt"
