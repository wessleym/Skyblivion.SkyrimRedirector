...
//For VR, manual changes must be made by uncommenting below, in Redirections.c (4 lines), and Test/Main.c (1 line). I may one day make a new solution configuration.
/*
